"""
Django settings for share_config project.
...
SECRET_KEY = m_secrets.SECRET_KEY
...
THIRD_PARTY = ['rest_framework', 'debug_toolbar', 'djoser', 'cloudinary', 'cloudinary_storage', 'phonenumbers']
...
ROOT_URLCONF = 'share_config.urls'
...
WSGI_APPLICATION = 'share_config.wsgi.application'
...
API_SECRET = m_secrets.SECRET_KEY
